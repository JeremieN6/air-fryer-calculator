        ...
        <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
            ...
            <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                <div>
                    ...
                    <h3 class="mb-2 text-xl font-semibold text-gray-700 dark:text-white">Cuisson personnalisée</h3>
                ...
                <div>
                    ...
                    <h3 class="mb-2 text-xl font-semibold text-gray-700 dark:text-white">Compatible avec tous les air fryers</h3>
                ...
                <div>
                    ...
                    <h3 class="mb-2 text-xl font-semibold text-gray-700 dark:text-white">Suggestions de préparation</h3>
                ...
                <div>
                    ...
                    <h3 class="mb-2 text-xl font-semibold text-gray-700 dark:text-white">Interface simple et rapide</h3>
                ...
                <div>
                    ...
                    <h3 class="mb-2 text-xl font-semibold text-gray-700 dark:text-white">Historique de vos cuissons <i>(à venir)</i></h3>
