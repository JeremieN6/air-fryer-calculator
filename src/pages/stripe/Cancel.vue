  ...
  <section class="bg-white dark:bg-gray-900">
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
      <div class="mx-auto max-w-screen-sm text-center">
        <h1 class="mb-4 text-7xl tracking-tight font-extrabold lg:text-9xl text-blue-600 dark:text-blue-500">400
        </h1>
        ...
        <p class="mb-4 text-lg font-light text-gray-500 dark:text-gray-400">Veuillez <a
            href="/calculateur-cuisson-air-fryer" class="text-blue-500 hover:text-blue-600">réessayer</a> ou <a
